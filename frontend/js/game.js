...
const MARKETS = {
  MX: {
    flag: '🇲🇽', name: 'México',
    countdown: '¡A conseguir seguidores!',
    btnLabel:  'Seguir',
    communityLabel: 'Tu comunidad:',
    winner:    '¡La comunidad más perrona!',
    playAgain: '¡Otra ronda! 👊',
    markers:   ['COMUNIDAD', 'FANS', 'COMPRADORES'],
    splashHeadline: '¡GANA SEGUIDORES!',
    splashSub:      'CRECE TU COMUNIDAD Y VENDE MÁS',
    goLabel:        '¡YA!',
    modalTitle:     'SELECCIONAR MERCADO',
    headerBanner:   'MÁS SEGUIDORES, MÁS VENTAS',
    watermark:      '¡GANA SEGUIDORES!',
  ...
  BR: {
    flag: '🇧🇷', name: 'Brasil',
    countdown: '¡Bora ganar seguidores!',
    btnLabel:  'Seguir',
    communityLabel: 'Sua comunidade:',
    winner:    '¡A maior comunidade!',
    playAgain: '¡Mais uma rodada!',
    markers:   ['COMUNIDADE', 'FIÉIS', 'COMPRADORES'],
    splashHeadline: '¡DISPARE SEGUIDORES!',
    splashSub:      'CRESÇA SUA COMUNIDADE E GERE MAIS VENDAS',
    goLabel:        'JÁ!',
    modalTitle:     'SELECIONAR MERCADO',
    headerBanner:   'MAIS SEGUIDORES, MAIS VENDAS',
    watermark:      '¡AUMENTE SEGUIDORES!',
  ...
  AR: {
    flag: '🇦🇷', name: 'Argentina',
    countdown: '¡A sumar seguidores!',
    btnLabel:  'Seguir',
    communityLabel: 'Tu comunidad:',
    winner:    '¡La comunidad más grande!',
    playAgain: '¡Jugá de nuevo! 🔄',
    markers:   ['COMUNIDAD', 'FIELES', 'COMPRADORES'],
    splashHeadline: '¡SUMÁ SEGUIDORES!',
    splashSub:      'HACÉ CRECER TU COMUNIDAD Y VENDÉ MÁS',
    goLabel:        '¡YA!',
    modalTitle:     'SELECCIONAR MERCADO',
    headerBanner:   'MÁS SEGUIDORES, MÁS VENTAS',
    watermark:      '¡SUMÁ SEGUIDORES!',
    autoResetLabel: 'volviendo en',
    difficultyTitle: 'DIFICULTAD',
    difficultyEasy:   'FÁCIL',
    difficultyMedium: 'MEDIO',
  ...
  CL: {
    flag: '🇨🇱', name: 'Chile',
    countdown: '¡A juntar seguidores!',
    btnLabel:  'Seguir',
    communityLabel: 'Tu comunidad:',
    winner:    '¡La comunidad más grande, po!',
    playAgain: '¡Otra patita! 🎮',
    markers:   ['COMUNIDAD', 'CAMISETEADOS', 'COMPRADORES'],
    splashHeadline: '¡JUNTA SEGUIDORES!',
    splashSub:      'CRECE TU COMUNIDAD Y VENDE MÁS',
    goLabel:        '¡AL TIRO!',
    modalTitle:     'SELECCIONAR MERCADO',
    headerBanner:   'MÁS SEGUIDORES, MÁS VENTAS',
    watermark:      '¡JUNTA SEGUIDORES!',
    autoResetLabel: 'volviendo en',
    difficultyTitle: 'DIFICULTAD',
    difficultyEasy:   'FÁCIL',
    difficultyMedium: 'MEDIO',
  ...
  CO: {
    ...
    btnLabel:  'Seguir',
    communityLabel: 'Tu comunidad:',
    winner:    '¡La comunidad más berraca!',
    playAgain: '¡Otra ronda! 👍',
    markers:   ['COMUNIDAD', 'FIELES', 'COMPRADORES'],
    splashHeadline: '¡SIGUE SUMANDO!',
    splashSub:      'HAGA CRECER SU COMUNIDAD Y VENDA MÁS',
    goLabel:        '¡YA!',
    modalTitle:     'SELECCIONAR MERCADO',
    headerBanner:   'MÁS SEGUIDORES, MÁS VENTAS',
    watermark:      '¡SIGUE SUMANDO!',
    autoResetLabel: 'volviendo en',
    difficultyTitle: 'DIFICULTAD',
    difficultyEasy:   'FÁCIL',
    difficultyMedium: 'MEDIO',
